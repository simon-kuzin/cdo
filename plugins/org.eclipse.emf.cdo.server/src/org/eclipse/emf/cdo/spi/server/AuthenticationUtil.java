...
{
  private static final ThreadLocal<IAuthenticationProtocol> authenticationProtocol = new ThreadLocal<IAuthenticationProtocol>();
  ...
  public static abstract class AuthenticatingOperation<V> implements Callable<V>
  {
    ...
    public final V call() throws Exception
    {
      ...
      try
      {
        AuthenticationUtil.authenticationProtocol.set(authenticationProtocol);
        result = doCall();
      }
      finally
      {
        AuthenticationUtil.authenticationProtocol.remove();
      }
