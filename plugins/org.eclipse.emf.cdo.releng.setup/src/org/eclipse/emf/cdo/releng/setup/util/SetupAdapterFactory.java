...
public class SetupAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SetupSwitch<Adapter> modelSwitch = new SetupSwitch<Adapter>()
  {
    ...
    @Override
    public Adapter caseInstallTask(InstallTask object)
    {
      return createInstallTaskAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.cdo.releng.setup.InstallTask <em>Install Task</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createInstallTaskAdapter()
  {
    return null;
  }
