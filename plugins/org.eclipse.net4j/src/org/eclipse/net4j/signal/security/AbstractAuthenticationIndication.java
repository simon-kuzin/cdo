 ...
 * @since 4.3
 */
public abstract class AbstractAuthenticationIndication extends IndicationWithMonitoring
{
  private Challenge challenge;

  public AbstractAuthenticationIndication(SignalProtocol<?> protocol, short id, String name)
  {
    super(protocol, id, name);
  }

  public AbstractAuthenticationIndication(SignalProtocol<?> protocol, short signalID)
  {
    super(protocol, signalID);
  }

  public AbstractAuthenticationIndication(SignalProtocol<?> protocol, Enum<?> literal)
  {
  ...
  protected abstract IPasswordCredentialsProvider getCredentialsProvider();
}
