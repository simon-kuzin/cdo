 ...
 * @since 4.3
 */
public abstract class AbstractAuthenticationRequest extends RequestWithMonitoring<Response>
{
  private final Challenge challenge;

  public AbstractAuthenticationRequest(SignalProtocol<?> protocol, short id, String name, Challenge challenge)
  {
    super(protocol, id, name);
    this.challenge = challenge;
  }

  public AbstractAuthenticationRequest(SignalProtocol<?> protocol, short signalID, Challenge challenge)
  {
    super(protocol, signalID);
    this.challenge = challenge;
  }

  public AbstractAuthenticationRequest(SignalProtocol<?> protocol, Enum<?> literal, Challenge challenge)
  {
