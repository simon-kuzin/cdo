...
public class InvalidationTest extends AbstractCDOTest
{
  ...
  public void testPassiveUpdateOnAndOff() throws Exception
  {
    ...
    ITimeOuter timeOuterB = new PollingTimeOuter(20, 100)
    {
      @Override
      protected boolean successful()
      {
    ...
    ITimeOuter timeOuterC = new PollingTimeOuter(20, 100)
    {
      @Override
      protected boolean successful()
      {
    ...
    ITimeOuter timeOuterB_2 = new PollingTimeOuter(20, 100)
    {
      @Override
      protected boolean successful()
      {
    ...
    ITimeOuter timeOuterC_2 = new PollingTimeOuter(20, 100)
    {
      @Override
      protected boolean successful()
      {
