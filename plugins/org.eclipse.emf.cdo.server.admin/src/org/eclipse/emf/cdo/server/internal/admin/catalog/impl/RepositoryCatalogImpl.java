...
public class RepositoryCatalogImpl extends CDOObjectImpl implements RepositoryCatalog
{
  ...
  public EList<AdminRepository> getRepositories()
  {
    return (EList<AdminRepository>)eGet(CatalogPackage.Literals.REPOSITORY_CATALOG__REPOSITORIES, true);
  }
   ...
   * @generated NOT
   */
  public AdminRepository getRepository(String name)
  {
    for (AdminRepository repository : getRepositories())
    {
