...
public interface CatalogPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.eclipse.emf.cdo.server.internal.admin.catalog.impl.AdminRepositoryImpl <em>Admin Repository</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.emf.cdo.server.internal.admin.catalog.impl.AdminRepositoryImpl
   * @see org.eclipse.emf.cdo.server.internal.admin.catalog.impl.CatalogPackageImpl#getAdminRepository()
   * @generated
   */
  int ADMIN_REPOSITORY = 1;
   ...
   * @ordered
   */
  int ADMIN_REPOSITORY__CONFIG_XML = 1;

  /**
   * The number of structural features of the '<em>Admin Repository</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ADMIN_REPOSITORY_FEATURE_COUNT = 2;

  /**
   * The number of operations of the '<em>Admin Repository</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ADMIN_REPOSITORY_OPERATION_COUNT = 0;
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository <em>Admin Repository</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Admin Repository</em>'.
   * @see org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository
   * @generated
   */
  EClass getAdminRepository();

  /**
   * Returns the meta object for the attribute '{@link org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository#getName()
   * @see #getAdminRepository()
   * @generated
   */
  EAttribute getAdminRepository_Name();

  /**
   * Returns the meta object for the attribute '{@link org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository#getConfigXML <em>Config XML</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Config XML</em>'.
   * @see org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository#getConfigXML()
   * @see #getAdminRepository()
   * @generated
   */
  EAttribute getAdminRepository_ConfigXML();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link org.eclipse.emf.cdo.server.internal.admin.catalog.impl.AdminRepositoryImpl <em>Admin Repository</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.emf.cdo.server.internal.admin.catalog.impl.AdminRepositoryImpl
     * @see org.eclipse.emf.cdo.server.internal.admin.catalog.impl.CatalogPackageImpl#getAdminRepository()
     * @generated
     */
    EClass ADMIN_REPOSITORY = eINSTANCE.getAdminRepository();
     ...
     * @generated
     */
    EAttribute ADMIN_REPOSITORY__NAME = eINSTANCE.getAdminRepository_Name();
     ...
     * @generated
     */
    EAttribute ADMIN_REPOSITORY__CONFIG_XML = eINSTANCE.getAdminRepository_ConfigXML();
