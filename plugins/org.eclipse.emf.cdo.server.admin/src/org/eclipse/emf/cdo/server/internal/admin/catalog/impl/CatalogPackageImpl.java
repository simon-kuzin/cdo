...
public class CatalogPackageImpl extends EPackageImpl implements CatalogPackage
{
   ...
   * @generated
   */
  private EClass adminRepositoryEClass = null;
   ...
   * @generated
   */
  public EClass getAdminRepository()
  {
    return adminRepositoryEClass;
  }
   ...
   * @generated
   */
  public EAttribute getAdminRepository_Name()
  {
    return (EAttribute)adminRepositoryEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getAdminRepository_ConfigXML()
  {
    return (EAttribute)adminRepositoryEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    adminRepositoryEClass = createEClass(ADMIN_REPOSITORY);
    createEAttribute(adminRepositoryEClass, ADMIN_REPOSITORY__NAME);
    createEAttribute(adminRepositoryEClass, ADMIN_REPOSITORY__CONFIG_XML);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getRepositoryCatalog_Repositories(), getAdminRepository(), null, "repositories", null, 0, -1,
        RepositoryCatalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    EOperation op = initEOperation(getRepositoryCatalog__GetRepository__String(), getAdminRepository(),
        "getRepository", 0, 1, IS_UNIQUE, IS_ORDERED);
    addEParameter(op, theEcorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);

    initEClass(adminRepositoryEClass, AdminRepository.class, "AdminRepository", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAdminRepository_Name(), ecorePackage.getEString(), "name", null, 1, 1, AdminRepository.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAdminRepository_ConfigXML(), theEtypesPackage.getClob(), "configXML", null, 1, 1,
        AdminRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
