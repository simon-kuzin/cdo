...
public interface RepositoryCatalog extends CDOObject
{
   ...
   * The list contents are of type {@link org.eclipse.emf.cdo.server.internal.admin.catalog.AdminRepository}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @generated
   */
  EList<AdminRepository> getRepositories();
   ...
   * @generated
   */
  AdminRepository getRepository(String name);
